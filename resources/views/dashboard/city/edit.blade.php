...
<div class="max-w-full grid format gap-12 bg-white sm:py-4 xl:py-6 ">
  ...
  <div class="mt-5 md:col-span-2 md:mt-0">
    <form action="/dashboard/city" method="post">
      @csrf
        <div class="space-y-6 bg-white py-2 sm:p-6">
          ...
          <div>
            ...
            <div class="mt-1 flex rounded-md shadow-sm">
              <input type="text" name="description" id="description" class="block w-full flex-1 rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm peer invalid:focus:ring-pink-600 invalid:text-pink-600 invalid:focus:border-pink-600" required autofocus value="{{ old('description') }}">
            </div>
          </div>
...
<script>
  ...
  title.addEventListener('change', function() {
    fetch('/dashboard/city/checkSlug?title=' + title.value)
